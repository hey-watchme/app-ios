...
### v9.20.0 (2025-08-16)
- **アバター機能の完全実装**: ユーザーと分析対象のアバター管理機能を実装
...
- **v9.17.0 - デバイスタイムゾーン中心の設計を全面実装**
  - **ライフログツールとしての設計思想を明確化**
    - 分析対象（デバイスを装着している人）の生活リズムを正確に記録
    - デバイスのタイムゾーン = 分析対象が生活している場所のタイムゾーン
